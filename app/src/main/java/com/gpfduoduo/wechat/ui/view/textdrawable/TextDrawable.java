package com.gpfduoduo.wechat.ui.view.textdrawable;
...
/**
 * Created by gpfduoduo on 15-4-30.
 */
public class TextDrawable extends ShapeDrawable {
    ...
    private TextDrawable(Builder builder) {
        ...
        color = builder.color;
        boderColor = builder.borderColor;
        ...
        borderPaint.setColor(getDarkerShade(boderColor));
    ...
    public static class Builder
            implements IShapeBuilder, IConfigBuilder, IBuilder {
        private String text;
        private int color;
        ...
        @Override public IConfigBuilder beginConfig() {
            return this;
        }


        @Override public IBuilder rect() {
            this.shape = new RectShape();
            return this;
        }


        @Override public IBuilder round() {
            this.shape = new OvalShape();
            return this;
        }


        @Override public IBuilder roundRect(int radius) {
            this.radius = radius;
        ...
        @Override public TextDrawable buildRect(String text, int color) {
            rect();
        ...
        @Override public TextDrawable buildRound(String text, int color) {
            round();
            return build(text, color);
        }


        @Override public TextDrawable build(String text, int color) {
            this.color = color;
            this.text = text;
        ...
        @Override public IConfigBuilder color(int color) {
            this.color = color;
            return this;
        }
        ...
        @Override public IConfigBuilder borderColor(int color) {
        ...
        @Override public IShapeBuilder endConfig() {
            return this;
        }
    }
    ...
    public interface IConfigBuilder {
        ...
        IConfigBuilder color(int color);
