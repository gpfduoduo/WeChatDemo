...
public class MediaRecorderBase implements Callback, PreviewCallback {
        ...
        if (camera != null) {
            try {
                ...
                if (mOnErrorListener != null) {
                    mOnErrorListener.onVideoError(MEDIA_ERROR_CAMERA_AUTO_FOCUS,
                            0);
                }
                if (e != null) Log.e(tag, "autoFocus", e);
            }
        }
        return false;
    }
    ...
    private String getAutoFocusMode() {
        if (mParameters != null) {
            ...
            if ((Build.MODEL.startsWith("GT-I950") ||
                    ...
                    isSupported(focusModes, "continuous-picture")) {
     ...
     */
    @SuppressLint("NewApi") @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
    ...
    private boolean setFlashMode(String value) {
        if (mParameters != null && camera != null) {
            try {
                if (Camera.Parameters.FLASH_MODE_TORCH.equals(value) ||
                        Camera.Parameters.FLASH_MODE_OFF.equals(value)) {
    ...
    public void setVideoBitRate(int bitRate) {
        if (bitRate > 0) mVideoBitrate = bitRate;
    }
            ...
            try {
                ...
                if (mOnErrorListener != null) {
                    mOnErrorListener.onVideoError(
                            MEDIA_ERROR_CAMERA_SET_PREVIEW_DISPLAY, 0);
                }
    ...
    protected void setPreviewCallback() {
        ...
        if (size != null) {
            ...
            Log.e(tag, "startPreview...setPreviewCallbackWithBuffer...width:" +
    ...
    public void testPreviewFrameCallCount() {
        new CountDownTimer(1 * 60 * 1000, 1000) {
            ...
            @Override public void onTick(long millisUntilFinished) {
                Log.e("[Vitamio Recorder]",
                        "testFrameRate..." + mPreviewFrameCallCount);
